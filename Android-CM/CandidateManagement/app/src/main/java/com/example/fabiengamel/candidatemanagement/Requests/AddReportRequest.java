...
/**
 * Created by Fabien gamel on 09/06/2017.
 */
public class AddReportRequest extends JsonObjectRequest {
    ...
    public AddReportRequest(String mail, String sessionId,int note, String link, String xpNote, String nsNote, String jobIdealNote,
        ...
        super(Request.Method.POST, ADD_REPORT_REQUEST_URL, null, listener, errorListener);
